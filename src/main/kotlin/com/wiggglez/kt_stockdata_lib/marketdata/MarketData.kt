package com.wiggglez.kt_stockdata_lib.marketdata

import com.wiggglez.kt_stockdata_lib.common.*
import com.wiggglez.kt_stockdata_lib.marketdata.dataobjects.*
import com.wiggglez.kt_stockdata_lib.marketdata.dataobjects.responses.RawUnusualOptionsActivityPage
...
//            )
     ...
     */
    override fun getUnusualOptionsActivity(pageNumber: Int,
                                           sortAsc: Boolean,
                                           sortBy: UoaSortByOptions): UnusualOptionsActivityPage? {
        return try {
